...
router.get(
  ...
  participantController.getParticipantAttendance
);
router.post('/attendance', participantController.upsertParticipantAttendance);
router.delete(
  '/attendance/:id',
  participantController.deleteParticipantAttendance
);
...
router.get(
  ...
  participantController.getParticipantSchedule
);
router.post(
  '/schedule/:participantid',
  participantController.upsertParticipantSchedule
);
router.delete(
  '/schedule/:participantid/:month/:year',
  participantController.deleteParticipantSchedule
);
